...
namespace MechanicShop.Domain.UnitTests.Customers
{
    public class CustomerTests
    {
        ...
        {
            var id = Guid.NewGuid();
            const string name = "Moaz";
            const string phoneNumber = "+201050429118";
            const string email = "moaz01@localhost";
        ...
        //Should Check each bussnies rule you have on create customer for ex. to know what happen when fail
