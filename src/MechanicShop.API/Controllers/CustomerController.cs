...
using MechanicShop.Application.Features.Customers.Command.RemoveCustomer;
using MechanicShop.Application.Features.Customers.Command.UpdateCustomer;
  ...
  //  [Authorize]
    public class CustomerController : ApiController
    {
        ...
        public async Task<IActionResult> CreateCustomer([FromBody] CreateCustomerRequest request, CancellationToken ct)
        {
            ...
            var result = await _sender.Send(new CreateCustomerCommand(request.Name, request.PhoneNumber, request.Email,vehicles), ct);

            return result.Match(response => CreatedAtRoute(
       ...
       // [Authorize(Roles = nameof(Role.Manager))]
        ...
        public async Task<IActionResult> Update(Guid customerId, [FromBody] UpdateCustomerRequest request, CancellationToken ct)
        {
            ...
            var command = new UpdateCustomerCommand(customerId,request.Name, request.PhoneNumber, request.Email,vehicles);
